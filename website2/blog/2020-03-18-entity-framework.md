...
image: "2020-03-18-entity-framework/banner-entityframework.png"
...
In order to now query our GraphQL server we need a GraphQL IDE to formulate queries and explore the schema. If you want a deluxe GraphQL IDE as an application, you can get our very own Banana Cakepop which can be downloaded [here](/docs/bananacakepop/bananacakepop-intro).

![Hot Chocolate](2020-03-18-entity-framework/banana-cake-pop.png)
...
![Hot Chocolate](2020-03-18-entity-framework/banana-cake-pop-address.png)
...
![Hot Chocolate](2020-03-18-entity-framework/banana-cake-pop-root-types.png)
...
![Hot Chocolate](2020-03-18-entity-framework/banana-cake-pop-expanded-schema.png)
...
![Hot Chocolate](2020-03-18-entity-framework/playground-root-types.png)

In our current schema we can see that we have a single root field called `students`. If we click on that the schema explorer opens and we can drill into our type. We can see what fields we can request from our `Student` type. We also can see that we can drill in further and fetch the enrollments and from the enrollments the courses and so on.

![Hot Chocolate](2020-03-18-entity-framework/playground-expanded-schema.png)
...
![Hot Chocolate](2020-03-18-entity-framework/banana-cake-pop-arguments.png)
