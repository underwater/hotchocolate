...
:::tip
We also have a template, which includes the configurations we have just made.
Just install the template using<br/>
`dotnet new -i HotChocolate.Templates.Server`
and now you can use
`dotnet new graphql`
to bootstrap your future GraphQL servers!
:::
...
![GraphQL IDE](/img/get-started-bcp.png)
...
![GraphQL IDE Schema Explorer](/img/get-started-bcp-schema-explorer.png)
...
Further, you can learn more about defining GraphQL schemas in .NET [here](defining-a-schema/schema-basics.md).
