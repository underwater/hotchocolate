...
![Visual Studio code showing the generated directory.](/img/berry_console_generated.png)
...
![Started console application that shows a list of sessions](/img/berry_console_session_list.png)
